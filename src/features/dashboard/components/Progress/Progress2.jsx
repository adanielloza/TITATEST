...
const sessionColumns = [
  ...
  { key: "aperturas", label: "Veces que abrió imagen" },
...
const Progress2 = ({ activityHistory }) => {
  ...
  const { chartData, labels, obtenerDetallePorFecha } = useActividad2Data(
